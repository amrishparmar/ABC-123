...
var e = [new Item('E', 'Eye', new Audio ('sound/alpha/Eye.mp3'), 'img/alpha/apple.png'), new Item('E', 'Eggs', new Audio ('sound/alpha/Eggs.mp3'), 'img/alpha/apple.png'), new Item('E', 'Elephant', new Audio ('sound/alpha/Elephant.mp3'), 'img/alpha/apple.png')];
var f = [new Item('F', 'Fire', new Audio ('sound/alpha/Fire.mp3'), 'img/alpha/apple.png'), new Item('F', 'Fish', new Audio ('sound/alpha/Fish.mp3'), 'img/alpha/apple.png'), new Item('F', 'Fox', new Audio ('sound/alpha/Fox.mp3'), 'img/alpha/apple.png')];
var g = [new Item('G', 'Girl', new Audio ('sound/alpha/Girl.mp3'), 'img/alpha/apple.png'), new Item('G', 'Goat', new Audio ('sound/alpha/Goat.mp3'), 'img/alpha/apple.png'), new Item('G', 'Goal', new Audio ('sound/alpha/Goal.mp3'), 'img/alpha/apple.png')];
var h = [new Item('H', 'Hotel', new Audio ('sound/alpha/Hotel.mp3'), 'img/alpha/apple.png'), new Item('H', 'Hair', new Audio ('sound/alpha/Hair.mp3'), 'img/alpha/apple.png'), new Item('H', 'Hospital', new Audio ('sound/alpha/Hospital.mp3'), 'img/alpha/apple.png')];
var i = [new Item('I', 'Ice-cream', new Audio ('sound/alpha/Ice-cream.mp3'), 'img/alpha/apple.png'), new Item('I', 'Igloo', new Audio ('sound/alpha/Igloo.mp3'), 'img/alpha/apple.png'), new Item('I', 'Ice', new Audio ('sound/alpha/Ice.mp3'), 'img/alpha/apple.png')];
var j = [new Item('J', 'Jam', new Audio ('sound/alpha/Jam.mp3'), 'img/alpha/apple.png'), new Item('J', 'Jelly', new Audio ('sound/alpha/Jelly.mp3'), 'img/alpha/apple.png'), new Item('J', 'Juice', new Audio ('sound/alpha/Juice.mp3'), 'img/alpha/apple.png')];
var k = [new Item('K', 'King', new Audio ('sound/alpha/King.mp3'), 'img/alpha/apple.png'), new Item('K', 'Kid', new Audio ('sound/alpha/Kid.mp3'), 'img/alpha/apple.png'), new Item('K', 'Kettle', new Audio ('sound/alpha/Kettle.mp3'), 'img/alpha/apple.png')];
var l = [new Item('L', 'Log', new Audio ('sound/alpha/Log.mp3'), 'img/alpha/apple.png'), new Item('L', 'Lock', new Audio ('sound/alpha/Lock.mp3'), 'img/alpha/apple.png'), new Item('L', 'Lemon', new Audio ('sound/alpha/Lemon.mp3'), 'img/alpha/apple.png')];
var m = [new Item('M', 'Man', new Audio ('sound/alpha/Man.mp3'), 'img/alpha/apple.png'), new Item('M', 'Mango', new Audio ('sound/alpha/Mango.mp3'), 'img/alpha/apple.png'), new Item('M', 'Maze', new Audio ('sound/alpha/Maze.mp3'), 'img/alpha/apple.png')];
var n = [new Item('N', 'Nun', new Audio ('sound/alpha/Nun.mp3'), 'img/alpha/apple.png'), new Item('N', 'Nail', new Audio ('sound/alpha/Nail.mp3'), 'img/alpha/apple.png'), new Item('N', 'Nut', new Audio ('sound/alpha/Nut.mp3'), 'img/alpha/apple.png')];
var o = [new Item('O', 'Orange', new Audio ('sound/alpha/Orange.mp3'), 'img/alpha/apple.png'), new Item('O', 'Oval', new Audio ('sound/alpha/Oval.mp3'), 'img/alpha/apple.png'), new Item('O', 'Octopus', new Audio ('sound/alpha/Octopus.mp3'), 'img/alpha/apple.png')];
var p = [new Item('P', 'Pencil', new Audio ('sound/alpha/Pencil.mp3'), 'img/alpha/apple.png'), new Item('P', 'Pig', new Audio ('sound/alpha/Pig.mp3'), 'img/alpha/apple.png'), new Item('P', 'Penguin', new Audio ('sound/alpha/Penguin.mp3'), 'img/alpha/apple.png')];
var q = [new Item('Q', 'Queen', new Audio ('sound/alpha/Queen.mp3'), 'img/alpha/apple.png'), new Item('Q', 'Question', new Audio ('sound/alpha/Question.mp3'), 'img/alpha/apple.png'), new Item('Q', 'Quiet', new Audio ('sound/alpha/Quite.mp3'), 'img/alpha/apple.png')];
var r = [new Item('R', 'Red', new Audio ('sound/alpha/Red.mp3'), 'img/alpha/apple.png'), new Item('R', 'Rocket', new Audio ('sound/alpha/Rocket.mp3'), 'img/alpha/apple.png'), new Item('R', 'Robot', new Audio ('sound/alpha/Robot.mp3'), 'img/alpha/apple.png')];
var s = [new Item('S', 'Spider', new Audio ('sound/alpha/Spider.mp3'), 'img/alpha/apple.png'), new Item('S', 'Sweet', new Audio ('sound/alpha/Sweet.mp3'), 'img/alpha/apple.png'), new Item('S', 'Squid', new Audio ('sound/alpha/Squid.mp3'), 'img/alpha/apple.png')];
var t = [new Item('T', 'Tree', new Audio ('sound/alpha/Tree.mp3'), 'img/alpha/apple.png'), new Item('T', 'Train', new Audio ('sound/alpha/Train.mp3'), 'img/alpha/apple.png'), new Item('T', 'Teddy', new Audio ('sound/alpha/Teddy.mp3'), 'img/alpha/apple.png')];
var u = [new Item('U', 'Up', new Audio ('sound/alpha/Up.mp3'), 'img/alpha/apple.png'), new Item('U', 'Umbrella', new Audio ('sound/alpha/Umbrella.mp3'), 'img/alpha/apple.png'), new Item('U', 'Unicorn', new Audio ('sound/alpha/Unicorn.mp3'), 'img/alpha/apple.png')];
var v = [new Item('V', 'Van', new Audio ('sound/alpha/Van.mp3'), 'img/alpha/apple.png'), new Item('V', 'Vet', new Audio ('sound/alpha/Vet.mp3'), 'img/alpha/apple.png'), new Item('V', 'Vegetables', new Audio ('sound/alpha/Vegetables.mp3'), 'img/alpha/apple.png')];
var w = [new Item('W', 'Water', new Audio ('sound/alpha/Water.mp3'), 'img/alpha/apple.png'), new Item('W', 'Watch', new Audio ('sound/alpha/Watch.mp3'), 'img/alpha/apple.png'), new Item('W', 'Wing', new Audio ('sound/alpha/Wing.mp3'), 'img/alpha/apple.png')];
var x = [new Item('X', 'X-ray', new Audio ('sound/alpha/X-ray.mp3'), 'img/alpha/apple.png'), new Item('X', 'Xylophone', new Audio ('sound/alpha/Xylophone.mp3'), 'img/alpha/apple.png'), new Item('X', 'Xenops', new Audio ('sound/alpha/Xenops.mp3'), 'img/alpha/apple.png')];
var y = [new Item('Y', 'Yellow', new Audio ('sound/alpha/Yellow.mp3'), 'img/alpha/apple.png'), new Item('Y', 'Yo-Yo', new Audio ('sound/alpha/Yo-Yo.mp3'), 'img/alpha/apple.png'), new Item('Y', 'Yogurt', new Audio ('sound/alpha/Apple.mp3'), 'img/alpha/apple.png')];
var z = [new Item('Z', 'Zero', new Audio ('sound/alpha/Zero.mp3'), 'img/alpha/apple.png'), new Item('Z', 'Zoo', new Audio ('sound/alpha/Zoo.mp3'), 'img/alpha/apple.png'), new Item('Z', 'Zebra', new Audio ('sound/alpha/Zebra.mp3'), 'img/alpha/apple.png')];
=======
...
var e = [new Item('E', 'Eye', new Audio ('sound/alpha/Eye.mp3'), 'img/alpha/eye.png'), new Item('E', 'Eggs', new Audio ('sound/alpha/Eggs.mp3'), 'img/alpha/eggs.jpg'), new Item('E', 'Elephant', new Audio ('sound/alpha/Elephant.mp3'), 'img/alpha/elephant.png')];
...
var j = [new Item('J', 'Jam', new Audio ('sound/alpha/Jam.mp3'), 'img/alpha/jam.jpg'), new Item('J', 'Jelly', new Audio ('sound/alpha/Jelly.mp3'), 'img/alpha/jelly.jpg'), new Item('J', 'Juice', new Audio ('sound/alpha/Juice.mp3'), 'img/alpha/Juice.png')];
...
var x = [new Item('X', 'X-ray', new Audio ('sound/alpha/X-ray.mp3'), 'img/alpha/x-ray.jpeg'), new Item('X', 'Xylophone', new Audio ('sound/alpha/Xylophone.mp3'), 'img/alpha/xylophone.png'), new Item('X', 'Xenops', new Audio ('sound/alpha/Xenops.mp3'), 'img/alpha/xenops.jpg')];
var y = [new Item('Y', 'Yellow', new Audio ('sound/alpha/Yellow.mp3'), 'img/alpha/yellow.png'), new Item('Y', 'Yo-Yo', new Audio ('sound/alpha/Yo-Yo.mp3'), 'img/alpha/yo-yo.png'), new Item('Y', 'Yogurt', new Audio ('sound/alpha/Apple.mp3'), 'img/alpha/yogurt.jpg')];
var z = [new Item('Z', 'Zero', new Audio ('sound/alpha/Zero.mp3'), 'img/alpha/zero.jpg'), new Item('Z', 'Zoo', new Audio ('sound/alpha/Zoo.mp3'), 'img/alpha/zoo.jpeg'), new Item('Z', 'Zebra', new Audio ('sound/alpha/Zebra.mp3'), 'img/alpha/zebra.jpg')];
>>>>>>> origin/master
