...
var k = [new Item('K', 'King', new Audio ('sound/alpha/King.mp3')), new Item('K', 'Kid', new Audio ('sound/alpha/Kid.mp3')), new Item('K', 'Kettle', new Audio ('sound/alpha/Kettle.mp3'))];
var l = [new Item('L', 'Log', new Audio ('sound/alpha/Log.mp3')), new Item('L', 'Lock', new Audio ('sound/alpha/Lock.mp3')), new Item('L', 'Lemon', new Audio ('sound/alpha/Lemon.mp3'))];
var m = [new Item('M', 'Man', new Audio ('sound/alpha/Man.mp3')), new Item('M', 'Mango', new Audio ('sound/alpha/Mango.mp3')), new Item('M', 'Maze', new Audio ('sound/alpha/Maze.mp3'))];
var n = [new Item('N', 'Nun', new Audio ('sound/alpha/Nun.mp3')), new Item('N', 'Nail', new Audio ('sound/alpha/Nail.mp3')), new Item('N', 'Nut', new Audio ('sound/alpha/Nut.mp3'))];
var o = [new Item('O', 'Orange', new Audio ('sound/alpha/Orange.mp3')), new Item('O', 'Oval', new Audio ('sound/alpha/Oval.mp3')), new Item('O', 'Octopus', new Audio ('sound/alpha/Octopus.mp3'))];
var p = [new Item('P', 'Pencil', new Audio ('sound/alpha/Pencil.mp3')), new Item('P', 'Pig', new Audio ('sound/alpha/Pig.mp3')), new Item('P', 'Penguin', new Audio ('sound/alpha/Penguin.mp3'))];
var q = [new Item('Q', 'Queen', new Audio ('sound/alpha/Queen.mp3')), new Item('Q', 'Question', new Audio ('sound/alpha/Question.mp3')), new Item('Q', 'Quiet', new Audio ('sound/alpha/Quite.mp3'))];
var r = [new Item('R', 'Red', new Audio ('sound/alpha/Red.mp3')), new Item('R', 'Rocket', new Audio ('sound/alpha/Rocket.mp3')), new Item('R', 'Robot', new Audio ('sound/alpha/Robot.mp3'))];
var s = [new Item('S', 'Spider', new Audio ('sound/alpha/Spider.mp3')), new Item('S', 'Sweet', new Audio ('sound/alpha/Sweet.mp3')), new Item('S', 'Squid', new Audio ('sound/alpha/Squid.mp3'))];
var t = [new Item('T', 'Tree', new Audio ('sound/alpha/Tree.mp3')), new Item('T', 'Train', new Audio ('sound/alpha/Train.mp3')), new Item('T', 'Teddy', new Audio ('sound/alpha/Teddy.mp3'))];
var u = [new Item('U', 'Up', new Audio ('sound/alpha/Up.mp3')), new Item('U', 'Umbrella', new Audio ('sound/alpha/Umbrella.mp3')), new Item('U', 'Unicorn', new Audio ('sound/alpha/Unicorn.mp3'))];
var v = [new Item('V', 'Van', new Audio ('sound/alpha/Van.mp3')), new Item('V', 'Vet', new Audio ('sound/alpha/Vet.mp3')), new Item('V', 'Vegetables', new Audio ('sound/alpha/Vegetables.mp3'))];
var w = [new Item('W', 'Water', new Audio ('sound/alpha/Water.mp3')), new Item('W', 'Watch', new Audio ('sound/alpha/Watch.mp3')), new Item('W', 'Wing', new Audio ('sound/alpha/Wing.mp3'))];
var x = [new Item('X', 'X-ray', new Audio ('sound/alpha/X-ray.mp3')), new Item('X', 'Xylophone', new Audio ('sound/alpha/Xylophone.mp3')), new Item('X', 'Xenops', new Audio ('sound/alpha/Xenops.mp3'))];
var y = [new Item('Y', 'Yellow', new Audio ('sound/alpha/Yellow.mp3')), new Item('Y', 'Yo-Yo', new Audio ('sound/alpha/Yo-Yo.mp3')), new Item('Y', 'Yogurt', new Audio ('sound/alpha/Apple.mp3'))];
var z = [new Item('Z', 'Zero', new Audio ('sound/alpha/Zero.mp3')), new Item('Z', 'Zoo', new Audio ('sound/alpha/Zoo.mp3')), new Item('Z', 'Zebra', new Audio ('sound/alpha/Zebra.mp3'))];
